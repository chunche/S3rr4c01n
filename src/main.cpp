...
uint256 hashGenesisBlock("0x99b8776323f0e051fb0e8c057c96bae09a1fee99bcabef5636de0afe60db3dec");
...
const string strMessageMagic = "SerraCoin Signed Message:\n";
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    if(nHeight > 800) // after block 800 
        nSubsidy = 250;
...
static const int64 nTargetTimespan = 15 * 4 * 60; // SerraCoin: 60 min
static const int64 nTargetSpacing = 4 * 60; // SerraCoin: 4 min
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlock *pblock)
{
    ...
    // SerraCoin: This fixes an issue where a 51% attack can change difficulty at will.
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal SerraCoin miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "SerraCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x64f1c4fb98fbfb642cd61fc103aea1e18a11f1d2b6f7f7a25419e66ff538c18b");
    }
	...
	// vMerkleTree: 5a2e19825b
        ...
        // Genesis block
        const char* pszTimestamp = "macorina pom pom macorina ponme la mano aqui y donde te agarro el temblor";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1395466231;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 2088907242;

        if (fTestNet)
        {
            block.nTime    = 1395457430;
            block.nNonce   = 386819966;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0x309f25268d5676a8158f500e221e18a23dbb85328b42fa16070a60179244185d"));
...
CBlock* CreateNewBlock(CReserveKey& reservekey)
{
    ...
    int64 nFees = 0;
    {
        ...
        while (!mapPriority.empty())
        {
            ...
            // SerraCoind: Reduce the exempted free transactions to 500 bytes (from Bitcoin's 3000 bytes)
